...
def promedio_zonas_espera():
  ...
  print("El promedio de tiempo de espera en las areas AE1, AE2, BE1 y BE2 es: {}".format(sum/cont))

def porcentaje_espera():  
  contW = 0
  total = 0
  decoded = open_json()
  for i in decoded:
...
def tiempos_espera():
  ...
  print ("El mayor tiempo de espera fue de {} y se produjo el dia: {} correspondiente al camion: {} en la zona : {}".format(tMayor, currentDateMayor, truckNameMayor, zoneMayor))
  print ("El menor tiempo de espera fue de: {} y se produjo el dia: {} correspondiente al camion: {} en la zona: ".format(tMenor, currentDateMenor, truckNameMenor, zoneMenor))

#En que zona se produce el mayor tiempo de espera
def zona_mayor_espera():
  cAE1 = 0
  cAE2 = 0
  cBE1 = 0
  cBE2 = 0
  ...
  print("Durante el periodo el mayor tiempo de espera se produjo en la estacion {} con un tiempo total acumulado de: {}".format(eMayor, mayor))

if __name__ == '__main__':
  promedio_zonas_espera()
  porcentaje_espera()
  tiempos_espera()
  zona_mayor_espera()